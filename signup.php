		...
		<div class="front" style="height: 80vh !important; top: 100px;">
			<form method="post" action="" name="sign" enctype="multipart/form-data" class="form-sup" style="top: 5%; left:55%;">
				<fieldset>
					...
					<input class="input" type="password" name="p2" required placeholder="Re-enter Password"><br>
					<input class="input" type="email" name="mail" required placeholder="someone@example.com" required><br>
